...
#     page_date = all_list_page.get_jbd_urls()
#     for item in page_date:
#         main(item, error_img_dir)
#
#
# def test_compare_sod_list():
#     page_date = all_list_page.get_sod_urls()
#     for item in page_date:
#         main(item, error_img_dir)
#
#
# def test_compare_acc_list():
#     page_date = all_list_page.get_acc_urls()
#     for item in page_date:
#         main(item, error_img_dir)
#
#
# def test_compare_sample_list():
#     page_date = all_list_page.get_sample_urls()
#     for item in page_date:
#         main(item, error_img_dir)
#
#
# def test_compare_swatch_list():
#     page_date = all_list_page.get_swatch_urls()
#     for item in page_date:
#         main(item, error_img_dir)
#
#
# def test_compare_rts_list():
#     page_date = all_list_page.get_rts_urls()
#     for item in page_date:
#         main(item, error_img_dir)


# test_compare_bd_list()
